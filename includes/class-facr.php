...
class FACR {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'comment_form_default_fields', $plugin_rating, 'rating_field' );
        $this->loader->add_action( 'comment_post', $plugin_rating, 'save_comment_meta_data' );
        $this->loader->add_filter( 'preprocess_comment', $plugin_rating, 'verify_comment_meta_data' );
        $this->loader->add_action( 'add_meta_boxes_comment', $plugin_rating, 'add_comment_meta_box' );
        $this->loader->add_action( 'edit_comment', $plugin_rating, 'extend_comment_edit_metafields' );
        $this->loader->add_filter( 'comment_text', $plugin_rating, 'modify_comment' );
	}
